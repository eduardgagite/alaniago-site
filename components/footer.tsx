  ...
  return (
    <footer className="bg-gradient-to-b from-alania-dark to-black border-t border-white/10 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-10 -left-10 sm:left-1/4 w-48 h-48 sm:w-64 sm:h-64 border border-alania-orange/5 rounded-full"></div>
        <div className="absolute bottom-10 -right-10 sm:right-1/4 w-32 h-32 sm:w-48 sm:h-48 border border-alania-amber/5 rounded-full"></div>
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-64 h-64 sm:w-96 sm:h-96 bg-gradient-orange opacity-5 rounded-full blur-3xl"></div>
      </div>
                ...
                <div className="flex flex-col space-y-2.5">
                  ...
                  <div className="pt-2">
                    <Button
                      ...
                      variant="outline"
                      size="sm"
                      className="border-alania-orange/50 hover:bg-alania-orange/10 text-alania-orange hover:text-alania-orange bg-transparent w-auto text-xs h-8 px-3"
                    >
